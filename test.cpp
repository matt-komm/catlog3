...
int main()
{
    ...
    root>>channel("bla",LogLevel::DEBUG)>>handler<ConsoleLogHandler>("handler",LogLevel::DEBUG);
    ...
    measure(root,"dict1",std::make_pair("file",1));
    measure(root,"dict2",std::make_pair("file",1),std::make_pair("file",__FILE__));
    measure(root,"dict3",std::make_pair("file",1),std::make_pair("file",__FILE__),std::make_pair("file",true));
